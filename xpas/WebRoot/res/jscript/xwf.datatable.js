...
window.xwf_datatable.prototype = {
...
//-- 初始化数据，基础方法 -----------------------------------------------------
window.xwf_datatable.prototype.addColumn = function (jsonColumn) {
    var jsonCol = {
...
window.xwf_datatable.prototype.readFromData = function (fieldString, dataString) {
...
window.xwf_datatable.prototype.readFromString = function (strDataSource) {
...
window.xwf_datatable.prototype.getColIndex = function (columnName) {
...
window.xwf_datatable.prototype.getColName = function (columnIndexOrName) {
...
window.xwf_datatable.prototype.close = function () {
...
//-- 排序 ---------------------------------------------------------------------
window.xwf_datatable.prototype.sort = function (strColumns) {
...
window.xwf_datatable.prototype._sortFunction = function (sortColumns, _this) {
...
window.xwf_datatable.prototype._sortCompare = function (value1, value2, objColumn) {
    var nCompare = 0;
...
//-- 查找、过滤、搜索 ---------------------------------------------------------
window.xwf_datatable.prototype.find = function (arrFind) {
...
window.xwf_datatable.prototype.filter = function (arrFind) {
...
window.xwf_datatable.prototype.search = function (arrSearch, strSearch) {
...
window.xwf_datatable.prototype.getSelectedRows = function () {
...
//-- 添加、删除记录 -----------------------------------------------------------
window.xwf_datatable.prototype.addRow = function (rowIndex) {
...
window.xwf_datatable.prototype.setDataCell = function (rowIndex, colIndex, newValue) {
...
window.xwf_datatable.prototype.removeAt = function (rowIndex) {
...
window.xwf_datatable.prototype.mergeDatatable = function (dtbNew) {
...
window.xwf_datatable.prototype.toString = function (strBaseFields) {
...
window.xwf_datatable.prototype.toHtmlTable = function (jsonPara) {
