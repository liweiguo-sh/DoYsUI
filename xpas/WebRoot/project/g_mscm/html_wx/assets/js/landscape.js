...
var landscape = function (option) {
  ...
  function createCss() {
    var cssBlock =
      ...
      '.' + _this.option.prefix + '_landscape img{width:25%;height:auto;-webkit-animation: ' + _this.option.prefix + '_landscapeAni 1.5s ease infinite alternate;animation: ' + _this.option.prefix + '_landscapeAni 1.5s ease infinite alternate;}' +
