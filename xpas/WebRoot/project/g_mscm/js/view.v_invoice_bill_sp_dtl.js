...
function viewExtraButtonClick (jsonProp) {
	    ...
	    if (btnExtra.btnKey.equals("invoiceRemoveButton")) {
	    	var billSpDtlId = btnExtra.drViewData.bill_sp_dtl_id.value;
	    	var obj = {
	    		viewKey: "v_invoice_bill_sp_dtl",
	    		billSpDtlId: billSpDtlId
	    	}
	    	if (g.a.send("processType=g_mscm.invoice.Invoice&actionType=removeInvoiceDtl", obj, true)) {
	    		if (g.a.OK) {
	    			var cReturn = g.a.cReturn;
	    			var billSpDtlId = cReturn.billSpDtlId;
	    			if (billSpDtlId) {
