...
window.xwf_window.prototype.createWindow = function (p) {
    ...
    arrHtml[idx++] = "<td id='" + this.prefix + "tdClose_" + windowId + "' class='" + this.prefix + "tdClose'><i class='el-icon-close'></i></td>";
...
window.xwf_window.prototype.onFormLoad = function (event) {
    ...
    if (contentWindow.winLoad) {
        contentWindow.winLoad();
    }
